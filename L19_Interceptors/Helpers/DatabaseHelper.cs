...
namespace L19_Interceptors.Helpers
{
	public static class DatabaseHelper
	{
		...
		public static void ShowBooks()
		{
			...
			foreach (var book in context.Books)
			{
				...
				Console.WriteLine($"Id: {book.Id}, Title: {bookTitle}, Author: {book.Author,20}, IsDeleted: {book.IsDeleted}, DeleteDate: {book.DeleteDate}");
			}
		}
	}
}
