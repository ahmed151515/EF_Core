...
{
    /// <inheritdoc />
    public partial class addScheduleentityandmanytomany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchedulesSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SchedulesSections_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SchedulesSections_Sections_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchedulesSections_ScheduleId",
                table: "SchedulesSections",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_SchedulesSections_SectionId",
                table: "SchedulesSections",
                column: "SectionId");
        }
